# Generated by Django 5.2.3 on 2025-06-29 19:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('composer', models.CharField(db_index=True, max_length=255)),
                ('arranger', models.CharField(blank=True, max_length=255, null=True)),
                ('instruments', models.CharField(help_text='Comma-separated list of instruments', max_length=255)),
                ...
                ('pdf_file', models.FileField(upload_to='scores/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['pdf']), scores.models.validate_file_size])),
